...
extension View {
    ...
    @ViewBuilder
    func noctyraSheetPresentation() -> some View {
        #if os(iOS)
    ...
    func noctyraSheetBackground() -> some View {
        background {
    ...
    func noctyraInputField(cornerRadius: CGFloat = 12) -> some View {
        modifier(NoctyraInputFieldModifier(cornerRadius: cornerRadius))
    }
...
private struct NoctyraInputFieldModifier: ViewModifier {
    @Environment(\.appTheme) private var theme
    @Environment(\.colorScheme) private var colorScheme
...
private struct NoctyraSheetBackground: View {
    @Environment(\.appTheme) private var theme
    @Environment(\.colorScheme) private var colorScheme
